...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Ldap CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Ldap controllers
...
# This target prepares repo for your provider by replacing all "ldap"
